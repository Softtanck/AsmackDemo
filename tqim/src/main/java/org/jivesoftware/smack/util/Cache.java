...
public class Cache<K, V> implements Map<K, V> {
    ...
    static class AbstractMapEntry<K, V> implements Entry<K, V> {
        final K key;
        V value;
         ...
         * <p/>
         * Implemented per API documentation of {@link Entry#equals(Object)}
         *
         ...
         * <p/>
         * Implemented per API documentation of {@link Entry#hashCode()}
         *
